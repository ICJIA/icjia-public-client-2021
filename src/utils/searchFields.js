...
// and the tests.
import SYNONYM_TABLE from "@/config/searchSynonyms.json";
...
// opening 60.
export const FULL_TEXT_CATEGORIES = ["pressRelease", "mediaAdvisory"];
...
// "pretrial" alone. The worker is given the table when it starts.
let SYNONYMS = {};
export function useSynonyms(table) {
  SYNONYMS = {};
